...
export const HELP_CONTENT: Record<string, HelpContent> = {
  applicantTable: {
    ...
    setup: "Choose the table where applicant submissions are stored. This is typically where form responses or application data is collected.",
    examples: [
      "Applications table",
      "Course Applications 2024",
      "Job Candidates"
    ],
    bestPractices: [
  ...
  applicantView: {
    purpose: "Choose which view of applicants to evaluate (filters and sorts applicants)",
  ...
  sourceField: {
    ...
    setup: "Select the field from your applicant table that contains the response you want to evaluate.",
    examples: [
    ...
    consequences: "The AI will only see the content from selected fields when making evaluations"
  },
  questionName: {
    purpose: "Override the field name with a clearer question for the AI evaluator",
    setup: "Provide a clear, descriptive name that helps the AI understand what this field represents.",
    examples: [
    ...
    consequences: "The AI will see this name instead of the original field name, affecting how it interprets the content"
  },
  evaluationTable: {
    purpose: "Select where evaluation results and scores will be stored",
    setup: "Choose the table where AI-generated evaluations, scores, and analysis will be saved.",
    examples: [
      "Evaluation Results",
      "AI Scores",
    ...
    consequences: "All evaluation results will be written to this table. Changing this resets field selections."
  },
  outputField: {
    purpose: "Select the field where AI evaluation scores will be stored",
    setup: "Choose a numeric field (Number, Percent, or Rating) where the AI's score for this criteria will be saved.",
    examples: [
    ...
    consequences: "AI scores will be written to this field. Existing values may be overwritten."
  },
  evaluationCriteria: {
    purpose: "Define what the AI should evaluate and how to score responses",
    setup: "Write clear instructions for the AI evaluator, including what to look for and scoring scale.",
    examples: [
    ...
    consequences: "Vague criteria lead to inconsistent scoring. Clear criteria improve AI accuracy and reliability."
  },
  dependencyField: {
    purpose: "Only evaluate if the selected input field contains a response",
    setup: "Choose an input field that must have content before this evaluation runs. Useful for conditional evaluations.",
    examples: [
    ...
    consequences: "Evaluation is skipped if the dependency field is empty, saving processing time and costs"
  },
  applicantField: {
    purpose: "Links evaluation records back to the original applicant",
    setup: "Select the field that creates the relationship between evaluations and applicants. Usually a 'Link to another record' field.",
    examples: [
      "Applicant",
      "Candidate",
      "Application"
    ...
    consequences: "Without this link, you won't know which evaluation belongs to which applicant"
  },
  logsField: {
    purpose: "Store detailed AI reasoning and decision process for transparency",
    setup: "Optional: Choose a long text field to store the AI's complete thought process and reasoning.",
    examples: [
      "AI Analysis",
      "Evaluation Notes",
      "Decision Logs"
    ...
    consequences: "Without logs, you won't see the AI's reasoning process. With logs, records will be larger but more transparent."
  }
}; 